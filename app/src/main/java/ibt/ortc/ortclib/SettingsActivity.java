...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("isCluster"));
        bindPreferenceSummaryToValue(findPreference("authToken"));
        bindPreferenceSummaryToValue(findPreference("appKey"));
        bindPreferenceSummaryToValue(findPreference("privateKey"));
        bindPreferenceSummaryToValue(findPreference("connMetada"));
        bindPreferenceSummaryToValue(findPreference("channel"));
